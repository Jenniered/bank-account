...
describe('transaction and statement integration', () => {
  ...
  it ('prints out statement with one deposit', () => { 
    ...
    account.makeDeposit(1000.00, "10/01/2023")
    const statement = new Statement(account);
    expect(statement.getStatement()).toEqual(["10/01/2023 || 1000.00 || 0.00 || 1000.00"])
  })
  ...
  it ('prints out statement for two deposits', () => { 
    ...
    account.makeDeposit(2000.00, "13/01/2023")
    const statement = new Statement(account);
    expect(statement.getStatement()).toEqual(["10/01/2023 || 1000.00 || 0.00 || 1000.00", "13/01/2023 || 2000.00 || 0.00 || 3000.00"])
  })
  ...
  it ('prints a statement for deposits and a withdrawal', () => { 
    ...
    const statement = new Statement(account);
    expect(statement.getStatement()).toEqual(["10/01/2023 || 1000.00 || 0.00 || 1000.00", "13/01/2023 || 2000.00 || 0.00 || 3000.00", "14/01/2023 || 0.00 || 500.00 || 2500.00"])
